...
const ComponentTable: React.FC = () => {
  ...
  const [selectedCoursing, setSelectedCoursing] = useState<IProductTag | null>(
    null
  );
  const [openDialog, setOpenDialog] = useState(false);
  const [openDeleteCategory, setOpenDeleteCategory] = useState(false);
  const [coursingToDelete, setCoursingToDelete] = useState<IProductTag | null>(
    null
  );
  ...
  const { data, isLoading, isError, refetch } = useGetProductTagQuery({
